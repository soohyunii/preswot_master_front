...
export default {
  "en": {
    ...
    "REG": {
      ...
      "EMAIL_LABEL": "E-mail",
      "EMAIL_PH": "abc@gmail.com",
      "ERR_DUPLICATED_EMAIL": "Duplicated E-mail. Try another.",
      "PASSWORD_LABEL": "Password",
      "PASSWORD_CHECK_LABEL": "Password Check",
      "NAME_LABEL": "Name",
      "NAME_PH": "John Doe",
      ...
      "ERR_REQUIRED": "Required.",
      "ERR_TOS_REQUIRED": "Please check your agreement to the Terms and Conditions",
  ...
  "ko": {
    ...
    "REG": {
      ...
      "EMAIL_LABEL": "이메일",
      "EMAIL_PH": "abc@gmail.com",
      "ERR_DUPLICATED_EMAIL": "중복된 이메일입니다. 다시 시도해주세요.",
      "PASSWORD_LABEL": "비밀번호",
      ...
      "ERR_REQUIRED": "필수 입력입니다.",
      "ERR_TOS_REQUIRED": "필수 약관에 동의를 체크 하셔야 합니다",
