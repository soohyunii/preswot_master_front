<template>
  <div id="class_index_wrapper">
    <div>
      ...
      <el-table-column prop="percentage" label="출석률" width="292px">
      </el-table-column>
      <el-table-column prop="understanding" label="이해도" width="292px">
      </el-table-column>
      <el-table-column prop="concentrating" label="집중도" width="292px">
      </el-table-column>
      <el-table-column prop="participation" label="참여도" width="292px">
      </el-table-column>
